(function ($) {
	...
	function positioningTimelineElements() {
        if ($(window).width() > 600) { // For large devices
            $('.timeline').each(function () {				
				...
				var tlineWrapH = 0;
				var tlineGutter = siteOptions.timeline.itemsSpace;
                ...
                var col2Top = siteOptions.timeline.topSpace;;
                var col2TopPrev = 0;
                var col2LastElemH = 0;		                				
    ...
    function availabilityCalendar() {						
        ...
        if (calendarHtml.length > 0) {				
            ...
            calendar = {
                ...
                busyDays: '',
                weekStart: '',
                weekNames: siteOptions.calendar.weekNames,
                daysInMonth: [31, 28, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31],
                monthNames: siteOptions.calendar.monthNames,
                init: function () {
                    this.initToday();
                    this.initWeekNames();
            ...
            calendar.limitUp.year = siteOptions.calendar.endYear; //calendar.currentYear + 1;
            calendar.limitUp.month = siteOptions.calendar.endMonth; //calendar.currentMonth;
            calendar.limitDown.year = siteOptions.calendar.startYear; //calendar.currentYear;
            calendar.limitDown.month = siteOptions.calendar.startMonth; //calendar.currentMonth;
            calendar.weekStart = siteOptions.calendar.weekStart;
            calendar.busyDays = siteOptions.calendar.busyDays;
    ...
    $(window).load(function () {
		...
		if(siteOptions.rtl){ // switch timeline box classes for RTL
